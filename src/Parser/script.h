...
namespace openvrml {
    ...
    public:
        ...
        virtual std::shared_ptr<script>
        create_script(script_node & node,
                      const std::shared_ptr<resource_istream> & source) = 0;
    ...
    private:
        virtual const std::shared_ptr<node_type>
    ...
    public:
        typedef std::map<std::string, std::shared_ptr<field_value> >
            field_value_map_t;
        ...
        typedef std::shared_ptr<openvrml::event_listener> event_listener_ptr;
        typedef std::map<std::string, event_listener_ptr> event_listener_map_t;
        typedef std::shared_ptr<eventout> eventout_ptr;
    ...
    private:
        ...
        static const std::shared_ptr<openvrml::event_listener>
        ...
        static std::shared_ptr<openvrml::event_emitter>
    ...
    private:
        OPENVRML_LOCAL std::shared_ptr<script> create_script()
