...
/**
 * @fn const std::shared_ptr<openvrml::node_type> openvrml::node_metatype::do_create_type(const std::string & id, const node_interface_set & interfaces) const
 *
 * @brief Create a new @c node_type.
 *
...
{
    assert(false);
    static const std::shared_ptr<node_type> type;
    return type;
}
...
openvrml::node_type::
create_node(const std::shared_ptr<scope> & scope,
...
/**
 * @fn const boost::intrusive_ptr<openvrml::node> openvrml::node_type::do_create_node(const std::shared_ptr<scope> & scope, const initial_value_map & initial_values) const
 *
 * @brief Create a new node with this @c node_type.
 *
 * Subclasses must implement this function.
...
do_create_node(const std::shared_ptr<openvrml::scope> &,
 ...
 * @internal
 *
 * @var std::shared_ptr<openvrml::scope> openvrml::node::scope_
 *
...
/**
 * @fn const std::shared_ptr<const openvrml::scope> & openvrml::node::scope() const
 *
