...
# include "viewer.h"
# include "local/uri.h"
# include "local/node_metatype_registry_impl.h"
# include "local/component.h"
# include "local/parse_vrml.h"
# include "private.h"
...
namespace {
    ...
    const std::shared_ptr<openvrml::scope> null_scope_ptr;
 ...
 */
std::shared_ptr<openvrml::node_type_decls>
 ...
 *                                  unsupported format.
 */
std::shared_ptr<openvrml::resource_istream>
...
/**
 * @fn std::shared_ptr<openvrml::resource_istream> openvrml::resource_fetcher::do_get_resource(const std::string & uri)
 *
 * @brief Fetch a network resource.
 *
 ...
 *
 *     shared_ptr<resource_istream> in(new file_resource_istream(path));
...
openvrml::node_metatype_registry::register_node_metatype(
    const std::string & id,
    const std::shared_ptr<node_metatype> & metatype)
    OPENVRML_THROW2(std::invalid_argument, std::bad_alloc)
{
 ...
 * @internal
 *
 * @var std::shared_ptr<openvrml::null_node_metatype> openvrml::browser::null_node_metatype_
 *
 ...
 * @internal
 *
 * @var std::shared_ptr<openvrml::null_node_type> openvrml::browser::null_node_type_
 *
 ...
 * @param[in] metatype  a @c std::shared_ptr to a @c node_metatype
 *
...
add_node_metatype(const node_metatype_id & id,
                  const std::shared_ptr<openvrml::node_metatype> & metatype)
    OPENVRML_THROW2(std::invalid_argument, std::bad_alloc)
{
    using boost::shared_lock;
    using boost::shared_mutex;
 ...
 */
const std::shared_ptr<openvrml::node_metatype>
