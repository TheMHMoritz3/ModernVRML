...
namespace {
    ...
    struct OPENVRML_LOCAL stream_reader {
        stream_reader(std::shared_ptr<openvrml::resource_istream> in,
                      std::shared_ptr<openvrml::stream_listener> listener):
            in_(in),
            listener_(listener)
        {}
    ...
    private:
        std::shared_ptr<openvrml::resource_istream> in_;
        std::shared_ptr<openvrml::stream_listener> listener_;
    };
}
 ...
 */
void openvrml::scene::read_stream(std::shared_ptr<resource_istream> in,
                                  std::shared_ptr<stream_listener> listener)
{
