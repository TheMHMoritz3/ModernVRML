...
namespace openvrml {
    ...
    OPENVRML_API
    std::shared_ptr<node_type_decls> profile(const std::string & profile_id)
    ...
    public:
        ...
        std::shared_ptr<resource_istream> get_resource(const std::string & uri);

    private:
        virtual std::shared_ptr<resource_istream>
