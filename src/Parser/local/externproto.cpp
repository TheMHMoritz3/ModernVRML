    ...
    void operator()() const OPENVRML_NOTHROW
    {
        try {
            ...
            try {
                ...
                shared_ptr<resource_istream> in =
...
void
openvrml::local::externproto_node_metatype::
set_proto_node_metatype(const std::weak_ptr<proto_node_metatype> & metatype)
...
openvrml::local::externproto_node_type::do_interfaces() const
{
    ...
    OPENVRML_THROW1(std::bad_alloc)
{
    ...
    return std::shared_ptr<field_value>(
...
const std::shared_ptr<openvrml::field_value>
    ...
    initial_values_(initial_values)
{
         ...
         ++interface_)
    {
        ...
        std::shared_ptr<openvrml::field_value> field_shared_ptr;
        ...
        case node_interface::field_id:
            field_shared_ptr = field_value::create(interface_->field_type);
            succeeded = this->field_map_
                .insert(
                    make_pair(interface_->id,
                              shared_ptr<field_value>(field_shared_ptr)))
                .second;
            break;
