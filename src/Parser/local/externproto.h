...
namespace openvrml {
    ...
    namespace local {
        ...
        class OPENVRML_LOCAL externproto_node_metatype :
            public std::enable_shared_from_this<externproto_node_metatype>,
            ...
            std::weak_ptr<proto_node_metatype> proto_node_metatype_;

            typedef std::vector<std::weak_ptr<externproto_node_type> >
        ...
        private:
            virtual const std::shared_ptr<openvrml::node_type>
            ...
            void set_proto_node_metatype(
                const std::weak_ptr<proto_node_metatype> & metatype =
                    std::weak_ptr<proto_node_metatype>())
        ...
        class OPENVRML_LOCAL externproto_node_type :
            ...
            const std::shared_ptr<const externproto_node_metatype>
                node_metatype_;

            openvrml::node_interface_set interfaces_;

            mutable boost::mutex mutex_;
            std::shared_ptr<openvrml::node_type> proto_node_type_;
        ...
        public:
            externproto_node_type(
                const std::shared_ptr<const externproto_node_metatype> & c,
                const std::string & id,
        ...
        class OPENVRML_LOCAL externproto_node :
            ...
            private:
                virtual std::shared_ptr<openvrml::field_value> do_clone() const
                    OPENVRML_THROW1(std::bad_alloc);
            ...
            struct externproto_exposedfield_creator {
                externproto_exposedfield_creator(
                    ...
                    std::shared_ptr<openvrml::field_value> & exposedfield):
                    node_(&node),
                    type_(type),
            ...
            private:
                ...
                std::shared_ptr<openvrml::field_value> * exposedfield_;
            };

            static const std::shared_ptr<openvrml::field_value>
