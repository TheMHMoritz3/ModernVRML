    ...
    namespace local {
        ...
        struct OPENVRML_LOCAL vrml97_parse_actions {
            ...
            struct on_proto_start_t {
                ...
                {
                    const std::shared_ptr<scope> outer_scope =
                    ...
                    if (interface_.type == node_interface::field_id
                        ...
                        pair<initial_value_map::iterator, bool> insert_result =
                            nd.initial_values.insert(
                                make_pair(
                                    interface_.id,
                                    std::shared_ptr<field_value>(value)));
            ...
            struct on_proto_default_value_start_t {
                ...
                void operator()() const
                {
                    ...
                    std::shared_ptr<scope> outer_scope = ps.scope;
            ...
            struct parse_scope {
                ...
                std::shared_ptr<openvrml::scope> scope;
