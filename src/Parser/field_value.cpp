...
# include "node.h"
# include "local/field_value_types.h"
 ...
 */
std::shared_ptr<openvrml::field_value::counted_impl_base>
...
/**
 * @fn std::shared_ptr<openvrml::field_value::counted_impl_base> openvrml::field_value::counted_impl_base::do_clone() const
 *
 * @brief Clone.
 *
...
/**
 * @var std::shared_ptr<ValueType> openvrml::field_value::counted_impl::value_
 *
...
/**
 * @fn std::shared_ptr<openvrml::field_value::counted_impl_base> openvrml::field_value::counted_impl::do_clone() const
 *
 ...
 * @internal
 *
 * @var std::shared_ptr<openvrml::field_value::counted_impl_base> openvrml::field_value::counted_impl_
 *
...
namespace {
    ...
    struct OPENVRML_LOCAL create_field_value {
        create_field_value(const openvrml::field_value::type_id type,
                           std::shared_ptr<openvrml::field_value> & fv):
            type_(type),
            field_value_(&fv)
        {}
    ...
    private:
        ...
        std::shared_ptr<openvrml::field_value> * field_value_;
    };
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value>
    ...
    OPENVRML_THROW1(std::bad_alloc)
{
    ...
    std::shared_ptr<field_value> result;
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::field_value::clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    std::shared_ptr<field_value> result = this->do_clone();
...
/**
 * @fn std::shared_ptr<openvrml::field_value> openvrml::field_value::do_clone() const
 *
 * @brief Polymorphically construct a copy.
 *
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfbool::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfbool(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfcolor::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfcolor(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfcolorrgba::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfcolorrgba(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sffloat::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sffloat(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfdouble::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfdouble(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfimage::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfimage(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfint32::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfint32(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfnode::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfnode(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfrotation::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfrotation(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfstring::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfstring(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sftime::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sftime(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfvec2f::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfvec2f(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfvec2d::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfvec2d(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfvec3f::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfvec3f(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::sfvec3d::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new sfvec3d(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mfbool::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mfbool(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mfcolor::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mfcolor(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mfcolorrgba::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mfcolorrgba(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mffloat::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mffloat(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mfdouble::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mfdouble(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mfimage::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mfimage(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mfint32::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mfint32(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mfnode::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mfnode(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mfrotation::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mfrotation(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mfstring::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mfstring(*this));
}
...
{
    return std::shared_ptr<field_value>(new mftime(*this));
}
...
{
    return std::shared_ptr<field_value>(new mfvec2f(*this));
}
...
{
    return std::shared_ptr<field_value>(new mfvec2d(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mfvec3f::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mfvec3f(*this));
}
 ...
 * @exception std::bad_alloc    if memory allocation fails.
 */
std::shared_ptr<openvrml::field_value> openvrml::mfvec3d::do_clone() const
    OPENVRML_THROW1(std::bad_alloc)
{
    return std::shared_ptr<field_value>(new mfvec3d(*this));
}
