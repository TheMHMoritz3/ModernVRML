...
/**
 * @var std::list<std::shared_ptr<openvrml::node_type> > openvrml::scope::node_type_list
 *
 ...
 * @internal
 *
 * @var const std::shared_ptr<const openvrml::scope> openvrml::scope::parent_
 *
 ...
 */
const std::shared_ptr<openvrml::scope> &
 ...
 */
const std::pair<std::shared_ptr<openvrml::node_type>, bool>
openvrml::scope::add_type(const std::shared_ptr<node_type> & type)
...
namespace {
    struct OPENVRML_LOCAL has_id_ :
        std::unary_function<std::shared_ptr<openvrml::node_type>, bool> {
        explicit has_id_(const std::string & id):
            id(&id)
        {}

        bool
        operator()(const std::shared_ptr<openvrml::node_type> & type) const
        {
            assert(type);
    ...
    typedef std::list<std::shared_ptr<openvrml::node_type> >
        node_type_list_t;
}
...
openvrml::scope::find_type(const std::string & id) const
{
    ...
    //
    static const std::shared_ptr<node_type> null;
    return this->parent_
