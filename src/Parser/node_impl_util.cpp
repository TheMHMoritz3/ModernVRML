...
/**
 * @typedef std::shared_ptr<openvrml::node_impl_util::ptr_to_polymorphic_mem<openvrml::field_value, Node> > openvrml::node_impl_util::node_type_impl<Node>::field_ptr_ptr
 *
...
/**
 * @typedef std::shared_ptr<openvrml::node_impl_util::ptr_to_polymorphic_mem<openvrml::event_listener, Node> > openvrml::node_impl_util::node_type_impl<Node>::event_listener_ptr_ptr
 *
 * @brief A @c shared_ptr to a pointer-to-member wrapper
 *        template.
 */
...
/**
 * @typedef std::shared_ptr<openvrml::node_impl_util::ptr_to_polymorphic_mem<openvrml::event_emitter, Node> > openvrml::node_impl_util::node_type_impl<Node>::event_emitter_ptr_ptr
 *
 * @brief A @c shared_ptr to a pointer-to-member wrapper
 *        template.
 */
...
/**
 * @fn std::shared_ptr<openvrml::field_value> openvrml::node_impl_util::abstract_node::exposedfield::do_clone() const
 *
...
/**
 * @fn openvrml::node_impl_util::abstract_node::abstract_node(const node_type & type, const std::shared_ptr<openvrml::scope> & scope)
 *
 * @brief Construct.
 *
...
/**
 * @fn const boost::intrusive_ptr<openvrml::node> openvrml::node_impl_util::node_type_impl::do_create_node(const std::shared_ptr<openvrml::scope> & scope, const openvrml::initial_value_map & initial_values) const
 *
