...
namespace openvrml {
    ...
    public:
        ...
        const std::shared_ptr<node_type>
    ...
    private:
        ...
        do_create_node(const std::shared_ptr<scope> & scope,
    ...
    class OPENVRML_API node : boost::noncopyable {
        ...
        const std::shared_ptr<openvrml::scope> scope_;
    ...
    public:
        ...
        std::shared_ptr<field_value> field(const std::string & id) const
            OPENVRML_THROW2(unsupported_interface, std::bad_alloc);
